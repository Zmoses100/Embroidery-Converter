<?php $__env->startSection('title', 'Conversion History'); ?>
...
<div class="space-y-6">
    ...
    <form method="GET" class="flex flex-wrap gap-3 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <select name="status" class="px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
            ...
            <?php $__currentLoopData = ['pending','processing','completed','failed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(request('status')): ?>
            <a href="<?php echo e(route('conversions.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors">Clear</a>
        <?php endif; ?>
    </form>
    ...
    <?php else: ?>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3 hidden md:table-cell">
                                <span class="text-xs font-semibold uppercase text-gray-700">
                                    <?php echo e($conv->source_format); ?> → <?php echo e($conv->target_format); ?>
                            ...
                            <td class="px-5 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('conversions.show', $conv)); ?>" class="text-xs text-primary-600 hover:text-primary-700 font-medium">View</a>
                                    <?php if($conv->outputFile): ?>
                                        <a href="<?php echo e(route('files.download', $conv->outputFile)); ?>" class="text-xs text-gray-500 hover:text-gray-700">Download</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="mt-4"><?php echo e($conversions->links()); ?></div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/Embroidery-Converter/Embroidery-Converter/resources/views/convert/history.blade.php ENDPATH**/ ?>