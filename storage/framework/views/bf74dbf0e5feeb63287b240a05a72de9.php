...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        <a href="<?php echo e(route('files.index')); ?>" class="text-gray-400 hover:text-gray-600">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
            </svg>
        </a>
        <h1 class="text-2xl font-bold text-gray-900 truncate"><?php echo e($file->original_name); ?></h1>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center justify-center">
            <?php if($file->preview_url): ?>
                <img src="<?php echo e($file->preview_url); ?>" alt="Preview" class="max-w-full max-h-64 object-contain rounded-lg">
            <?php else: ?>
                <div class="w-32 h-32 bg-primary-50 rounded-xl flex items-center justify-center mb-4">
                    <span class="text-4xl font-bold text-primary-300 uppercase"><?php echo e($file->extension); ?></span>
                </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <dl class="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
                <div>
                    ...
                    <dd class="font-medium text-gray-900 uppercase"><?php echo e($file->extension); ?></dd>
                </div>
                <div>
                    <dt class="text-gray-500">File Size</dt>
                    <dd class="font-medium text-gray-900"><?php echo e($file->size_human); ?></dd>
                </div>
                <?php if($file->stitch_count): ?>
                <div>
                    <dt class="text-gray-500">Stitch Count</dt>
                    <dd class="font-medium text-gray-900"><?php echo e(number_format($file->stitch_count)); ?></dd>
                </div>
                <?php endif; ?>
                <?php if($file->color_count): ?>
                <div>
                    <dt class="text-gray-500">Thread Colors</dt>
                    <dd class="font-medium text-gray-900"><?php echo e($file->color_count); ?></dd>
                </div>
                <?php endif; ?>
                <?php if($file->dimensions): ?>
                <div>
                    <dt class="text-gray-500">Dimensions</dt>
                    <dd class="font-medium text-gray-900"><?php echo e($file->dimensions); ?></dd>
                </div>
                <?php endif; ?>
                <?php if($file->hoop_size): ?>
                <div>
                    <dt class="text-gray-500">Hoop Size</dt>
                    <dd class="font-medium text-gray-900"><?php echo e($file->hoop_size); ?></dd>
                </div>
                <?php endif; ?>
                <div>
                ...
                <div>
                    ...
                    <dd class="font-medium text-gray-900"><?php echo e($file->created_at->format('M d, Y')); ?></dd>
                </div>
            </dl>

            <!-- Thread Colors -->
            <?php if($file->thread_colors): ?>
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <p class="text-sm text-gray-500 mb-2">Thread Colors</p>
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = array_slice($file->thread_colors, 0, 20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-1.5">
                                <div class="w-4 h-4 rounded-full border border-gray-200"
                                     style="background-color: <?php echo e($color['color'] ?? '#ccc'); ?>"></div>
                                <span class="text-xs text-gray-500"><?php echo e($color['name'] ?? $color['color'] ?? ''); ?></span>
                            </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__currentLoopData = $conversions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-3">
                                <span class="font-medium uppercase text-primary-700"><?php echo e($conv->target_format); ?></span>
                            </td>
                            <td class="px-5 py-3">
                            ...
                            <td class="px-5 py-3 text-gray-500 text-xs"><?php echo e($conv->created_at->format('M d, Y H:i')); ?></td>
                            <td class="px-5 py-3 text-right">
                                <?php if($conv->outputFile): ?>
                                    <a href="<?php echo e(route('files.download', $conv->outputFile)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/Embroidery-Converter/Embroidery-Converter/resources/views/files/show.blade.php ENDPATH**/ ?>