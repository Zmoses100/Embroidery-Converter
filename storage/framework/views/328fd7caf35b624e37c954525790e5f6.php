...
<head>
    ...
    <title><?php echo e(config('app.name', 'Embroidery Converter')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                    ...
                    <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route($item['route'])); ?>"
                           class="group flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                                  <?php echo e(request()->routeIs($item['route']) ? 'bg-primary-600 text-white' : 'text-primary-200 hover:bg-primary-600 hover:text-white'); ?>">
                    ...
                    <div class="mt-6 px-3">
                        ...
                        <div class="mt-2 space-y-1">
                            <a href="<?php echo e(route('admin.dashboard')); ?>"
                               class="group flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-primary-200 hover:bg-primary-600 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.*') ? 'bg-primary-600 text-white' : ''); ?>">
            ...
            <div class="p-4 border-t border-primary-600">
                <div class="flex items-center gap-3">
                    <img src="<?php echo e(auth()->user()?->avatar_url); ?>" alt="Avatar" class="w-9 h-9 rounded-full">
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-white truncate"><?php echo e(auth()->user()?->name); ?></p>
                        <p class="text-xs text-primary-300 truncate"><?php echo e(auth()->user()?->activePlan()?->name ?? 'Free'); ?> plan</p>
                    </div>
                </div>
                <div class="mt-3 flex gap-2">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="flex-1 text-center text-xs text-primary-300 hover:text-white py-1">Settings</a>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm h-16 flex items-center justify-between px-4 lg:px-6">
                ...
                <div class="flex items-center gap-4 ml-auto">
                    ...
                    <a href="<?php echo e(route('notifications.index')); ?>" class="relative p-2 text-gray-500 hover:text-gray-700">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                        </svg>
                        <?php if($unreadCount > 0): ?>
                            <span class="absolute top-1 right-1 w-4 h-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center"><?php echo e($unreadCount); ?></span>
                        <?php endif; ?>
                    </a>

                    <!-- User avatar -->
                    <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2">
                        <img src="<?php echo e(auth()->user()?->avatar_url); ?>" alt="Avatar" class="w-8 h-8 rounded-full">
            ...
            <div class="px-4 lg:px-6 pt-4 space-y-2">
                ...
                <?php endif; ?>
                <?php if(session('warning') || session('warnings')): ?>
                    <div class="flex items-start gap-2 bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-lg px-4 py-3">
                        ...
                        <div class="text-sm">
                            <?php if(session('warning')): ?><?php echo e(session('warning')); ?><?php endif; ?>
                            <?php if(session('warnings')): ?><?php $__currentLoopData = session('warnings'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><p><?php echo e($w); ?></p><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php endif; ?>
                        </div>
                    </div>
                @endif
            </div>
...
<?php /**PATH /home/runner/work/Embroidery-Converter/Embroidery-Converter/resources/views/layouts/app.blade.php ENDPATH**/ ?>